// Alert Dialog components built on Radix UI for accessibility and composability
...
// Portal to render dialog outside normal DOM flow
...
// Main dialog content with animations and centered layout
...
// Export reusable alert dialog components
export {
  AlertDialog,
  AlertDialogPortal,
  AlertDialogOverlay,
